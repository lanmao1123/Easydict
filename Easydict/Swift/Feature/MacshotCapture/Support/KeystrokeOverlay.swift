...
class KeystrokeOverlay: NSPanel {
    ...
    init(screen: NSScreen) {
        self.keystrokeView = KeystrokeView()
        super.init(
    ...
    nonisolated private static func keyNameFromCode(_ keyCode: UInt16, event: CGEvent) -> String {
        ...
        case kVK_CapsLock, kVK_Command,
             kVK_Control, kVK_Function,
             kVK_Option, kVK_RightCommand,
             kVK_RightControl, kVK_RightOption,
