...
class EmojiPickerView: NSView {
    ...
    override func draw(_ dirtyRect: NSRect) {
        ...
        for (i, cat) in cats.enumerated() {
            ...
            tabStr.draw(
                at: NSPoint(x: tabRect.midX - tabSize.width / 2, y: tabRect.midY - tabSize.height / 2),
        ...
        for (i, emoji) in emojis.enumerated() {
            ...
            str.draw(
                at: NSPoint(x: cellRect.midX - size.width / 2, y: cellRect.midY - size.height / 2),
