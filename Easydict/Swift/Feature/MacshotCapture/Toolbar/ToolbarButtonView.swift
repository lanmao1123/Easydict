...
class ToolbarButtonView: NSView {
    ...
    var onClick: ((ToolbarButtonAction) -> ())?
    var onMouseDown: ((ToolbarButtonAction) -> ())?
    var onRightClick: ((ToolbarButtonAction, NSView) -> ())?
    var onHover: ((ToolbarButtonAction, Bool) -> ())? // (action, isHovered)
    ...
    var tintColor: NSColor = ToolbarLayout
        .iconColor { didSet { cachedIcon = nil; cachedIconIsOn = nil; needsDisplay = true } }
